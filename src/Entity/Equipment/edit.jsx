...
function Edit() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    await axios.put(`http://localhost:8080/equipment/updateEquipment/${e_id}`, equipment);
    navigate("/Check");
  ...
  return (
    <div className='container-fluid'>
      <div>
        <h2 className='mt-5' style={{ width: "100%", marginTop: "100px" }}>  Edit <hr />Equipments</h2></div>
